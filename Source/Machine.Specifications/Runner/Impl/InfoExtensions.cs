...
namespace Machine.Specifications.Runner.Impl
{
  public static class InfoExtensions
  {
    ...
    {
      return new SpecificationInfo(specification.Leader, specification.Name, specification.FieldInfo.DeclaringType.FullName, specification.FieldInfo.Name, specification.FieldInfo.DeclaringType.Assembly.GetName().Name);
    }
  }
}